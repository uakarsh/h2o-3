...
#' @param standardize_TP_gam_cols \code{Logical}. standardize TP predictor columns Defaults to FALSE.
#' @param scale_TP_penalty_mat \code{Logical}. Save keys of model matrix Defaults to FALSE.
